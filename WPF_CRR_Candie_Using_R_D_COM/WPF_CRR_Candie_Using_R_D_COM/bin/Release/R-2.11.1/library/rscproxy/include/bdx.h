 ...
 * 2 ... removed Variant2BDX, BDX2Variant
 */
#define BDX_VTBL_VERSION_1 1
#define BDX_VTBL_VERSION_2 2
#define BDX_VTBL_VERSION BDX_VTBL_VERSION_2
...
#define BDX_DT      0x00000003 /* date & time */
#define BDX_DOUBLE  0x00000004
#if 0
#define BDX_CY      0x00000005 /* currency */
#endif
...
{
  unsigned long bool_value;      /* BDX_BOOL    */
  double        double_value;    /* BDX_DOUBLE  */
  long int      int_value;       /* BDX_INT     */
  char*         string_value;    /* BDX_STRING  */
  unsigned long special_value;   /* BDX_SPECIAL */
  void*         ptr;             /* BDX_HANDLE  */
  /* BEDX_DT: date&time in seconds since 1970-01-01 00:00 */
  double        dt_value;
#if 0
  cy_value;        /* BDX_CY      */
#endif
...
typedef struct _BDX_Vtbl2 BDX_Vtbl;
